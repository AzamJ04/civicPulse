...
const reports = [
  ...
  },
  {
    ...
    priority: 'critical', status: 'resolved', location: 'Cedar Boulevard & 4th Ave', votes: 67,
  ...
  },
  {
    ...
    priority: 'high', status: 'progress', location: '12th Street, Harbor Blvd to Park Gate', votes: 38,
  ...
  },
  {
    ...
    priority: 'high', status: 'progress', location: 'Oak Street, 200m north of Central Park', votes: 54,
...
function updateReportStatus(newStatus) {
  ...
  if (newStatus === 'resolved') {
    ...
    showToast('🔧 Issue marked as In Progress');
  }
